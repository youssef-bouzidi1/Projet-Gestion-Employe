...
import com.hrms.absence.model.LeaveStatus;
...
public class LeaveService {
    ...
    public Leave requestLeave(Leave leave) {
        leave.setStatus(LeaveStatus.PENDING);  // Use Leave.LeaveStatus here
    ...
    public Leave approveLeave(Long leaveId, Long approverId) {
        ...
        leave.setStatus(LeaveStatus.APPROVED);  // Use Leave.LeaveStatus here
    ...
    public Leave rejectLeave(Long leaveId, Long approverId) {
        ...
        leave.setStatus(LeaveStatus.REJECTED);  // Use Leave.LeaveStatus here
        leave.setApproverId(approverId);
        return leaveRepository.save(leave);
    }
